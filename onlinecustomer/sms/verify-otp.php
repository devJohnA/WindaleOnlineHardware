...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("SELECT CUSTOMERID FROM tblcustomer WHERE PHONE = ? AND OTP = ? AND OTP_TIMESTAMP > NOW() - INTERVAL 15 MINUTE");
    ...
    if ($result->num_rows > 0) {
        ...
        $clear_stmt = $conn->prepare("UPDATE tblcustomer SET OTP = NULL, OTP_TIMESTAMP = NULL WHERE PHONE = ?");
