                ...
                <div class="container py-5">
                    <div class="row">
                        <div class="col-md-6 col-lg-5 col-xl-4 mb-4 mb-md-0">
                            ...
                            <button id="setStatusBtn" class="btn btn-primary mb-3 text-white" data-bs-toggle="modal" data-bs-target="#statusModal">Set Status</button>
                            <div class="card">
                                <div class="card-body">
    ...
    fetch('fetchMessages.php')
        ...
        .then(data => {
            ...
            data.users.forEach(user => {
                ...
                const isUnread = !isMessageRead(user.id);
                const textClass = isUnread ? 'font-weight-bold' : 'text-muted';

                listItem.innerHTML = `
                    <div class="d-flex flex-row justify-content-between align-items-center">
                        <div class="pt-1">
                            <p class="${textClass} mb-0">${user.name}</p>
                            <p class="small ${textClass}">${user.message}</p>
                        </div>
                        <div>
            ...
            if (activeUserId) {
                ...
                if (activeItem) {
                    ...
                    updateChatItemStyle(activeItem, false);
                }
            }
        });
...
function updateChatItemStyle(item, isUnread) {
