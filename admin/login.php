...
$recaptcha_site_key = '6Lcjy34qAAAAAD0k2NNynCgcbE6_W6Fy9GotDBZA'; 
...
<body>
    ...
    <form id="loginForm" method="post" action="">
        ...
        <p class="text-end" style="float:right;"><a href="choose-forgotpass.php" class="p">Forgot Password?</a></p>
