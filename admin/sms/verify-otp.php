...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("SELECT USERID FROM tbluseraccount WHERE U_CON = ? AND OTP = ? AND OTP_TIMESTAMP > NOW() - INTERVAL 15 MINUTE");
    ...
    if ($result->num_rows > 0) {
        ...
        $clear_stmt = $conn->prepare("UPDATE tbluseraccount SET OTP = NULL, OTP_TIMESTAMP = NULL WHERE U_CON = ?");
