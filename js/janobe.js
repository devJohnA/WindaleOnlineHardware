...
$(document).on("keyup", ".QTY", function () {
 ...
 if (parseInt(originalqty.value)<=parseInt(qty.value)){
  ...
  // alert("sThe quantity that you put is greater than the availabe quantity of the product.");
...
var table = document.getElementById('table');
    ...
    var fee = 0.00
     ...
     if (deliveryfee.checked==true){
          document.getElementById('fee').innerHTML =  document.getElementById('PLACE').value;
